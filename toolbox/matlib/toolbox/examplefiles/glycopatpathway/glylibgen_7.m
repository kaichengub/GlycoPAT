function glycluster = glylibgen_7()
% glyseed = {'Man9.glycoct_xml';'tri_SSS.glycoct_xml'};
substrateArray = CellArrayList;
s1species = GlycanSpecies(glycanMLread('Man9.glycoct_xml'));
s2species = GlycanSpecies(glycanMLread('bi_SS.glycoct_xml'));
s3species = GlycanSpecies(glycanMLread('bi_SS_f.glycoct_xml'));
s4species = GlycanSpecies(glycanMLread('tri_SSS.glycoct_xml'));
s5species = GlycanSpecies(glycanMLread('tri_SSS_f.glycoct_xml'));
s6species = GlycanSpecies(glycanMLread('tetra_sia.glycoct_xml'));

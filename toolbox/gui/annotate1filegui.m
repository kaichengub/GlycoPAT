function varargout = annotate1filegui(varargin)
% ANNOTATE1FILEGUI: Start a GUI to display annoated MS2 spectra 
% and a list of matched peaks 
%
...
% --- Executes when selected cell(s) is changed in uitable_matchpeaklist.
function uitable_matchpeaklist_CellSelectionCallback(hObject, eventdata, handles)
% hObject    handle to uitable_matchpeaklist (see GCBO)

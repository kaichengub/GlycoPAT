    ...
    outputFile     ='output3cSoln.txt';            % name of output file located in 'directory'
    stdsolfilename ='Test3cSoln.txt';
    Enzyme         ={'Glu-c'};                     % digesting enzyme (can be array of stings to allow for multiple cleavages)

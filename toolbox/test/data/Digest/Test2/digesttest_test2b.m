    ...
    proteinInput   ='2proteins.txt';                   % This is the file containing the protein sequence information
    fixedInput     ='fixedptmtest2b.txt';                % This file contains information on fixed PTM modifications
    variableInput  ='variableptmtest2b.txt';             % This file contains information on variable PTM modifications
    outputFile     ='output2bSoln.txt';            % name of output file located in 'directory'
    stdsolfilename ='Test2bSoln.txt';

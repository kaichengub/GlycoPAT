    ...
    fixedInput='fixedptm9.txt';                     % This file contains information on fixed PTM modifications
    variableInput='variableptm9.txt';               % This file contains information on variable PTM modifications
    outputFile='output9Soln.txt';                    % name of output file located in 'directory'
    stdsolfilename='Test9Soln.txt';

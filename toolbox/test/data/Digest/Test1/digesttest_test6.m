    ...
    fixedInput='fixedptm6.txt';                     % This file contains information on fixed PTM modifications
    variableInput='variableptm6.txt';               % This file contains information on variable PTM modifications
    outputFile='output6Soln.txt';                    % name of output file located in 'directory'
    stdsolfilename='Test6Soln.txt';

    ...
    fixedInput='fixedptm2.txt';                                             % This file contains information on fixed PTM modifications
    variableInput='variableptm2.txt';                                       % This file contains information on variable PTM modifications
    outputFile='output2Soln.txt';                    % name of output file located in 'directory'
    stdsolfilename='Test2Soln.txt';

    ...
    outputFile='output7dSoln.txt';                    % name of output file located in 'directory'
    stdsolfilename='Test7dSoln.txt';
    Enzyme={'Trypsin';'Glu-C(V8 DE)'};                              % digesting enzyme (can be array of stings to allow for multiple cleavages)
    ...
    maxPTM=0;                                      % Restrict number of variable PTM modifications

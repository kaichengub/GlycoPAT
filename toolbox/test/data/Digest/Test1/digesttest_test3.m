    ...
    fixedInput='fixedptm3.txt';                     % This file contains information on fixed PTM modifications
    variableInput='variableptm3.txt';               % This file contains information on variable PTM modifications
    outputFile='output3Soln.txt';                    % name of output file located in 'directory'
    stdsolfilename='Test3Soln.txt';

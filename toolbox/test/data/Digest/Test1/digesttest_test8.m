    ...
    fixedInput='fixedptm8.txt';                     % This file contains information on fixed PTM modifications
    variableInput='variableptm8.txt';               % This file contains information on variable PTM modifications
    outputFile='output8Soln.txt';                    % name of output file located in 'directory'
    stdsolfilename='Test8Soln.txt';

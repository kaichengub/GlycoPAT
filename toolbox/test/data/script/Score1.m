...
Pepfile='D:\Working\Dropbox\glycoPAT\version_check121016\GlycoPAT_submit\toolbox\test\data\score\dta files from paper\Test_digested.txt';                     % specify location where the output of the digestscript file is stored.
%DataDirectory='G:\crash\MATLAB_programs\GPA\testData\dta files from JBC paper';    
DataDirectory='D:\Working\Dropbox\glycoPAT\version_check121016\GlycoPAT_submit\toolbox\test\data\score\dta files from paper'; % specify location where .dta files are stored
...
Outfname='Test_out.csv';  % Output is comma separated file that can be read using excel. Specify .csv file name here
...
%[hit]=scoreAllSpectra(Pepfile,DataDirectory,fragMode,MS1tol,MS1tolUnit,MS2tol,MS2tolUnit,...
 %   OutputDir,Outfname,maxlag,CutOffMed,FracMax,nmFrag,npFrag,ngFrag,selectPeak,glycanOnly,veryLabilePTM, pseudoLabilePTM);
    end